...
main (int argc, char* const* argv)
{
  ...
  try {
	  ...
	  {
		  std::cerr << "Error: could not load the category names from dataset."
					<< std::endl;
		  return EXIT_FAILURE;
	  }
	  ...
	  if (classifier==0)
	  {
		...
		//	Reference:	https://docs.opencv.org/3.4/dd/de1/classcv_1_1ml_1_1KNearest.html#a99bf8ce6bba7fcfdd791c6e5eedae8ac
	  ...
	  else if (classifier==1)
	  {
		...
		//	Reference:	https://docs.opencv.org/3.4/d1/d2d/classcv_1_1ml_1_1SVM.html#a7b05db6110aec2246f2b31363937539c
	  ...
	  else if (classifier==2)
	  {
		...
		//	Reference:	https://docs.opencv.org/3.4/d0/d65/classcv_1_1ml_1_1RTrees.html#adada11573469e5df2e05da93e8239704
